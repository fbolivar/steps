...
### Skills Invocables (usuario o agente los activa)
...
| 9 | `sprint` | Tareas rapidas (1-3 archivos): bugs, ajustes, refactors simples |
...
| 14 | `update-sf` | Actualizar SaaS Factory a la ultima version |
...
| 18 | `video-visuals` | Paquetes visuales narrativos estilo sketchnote para videos |
| 19 | `autoresearch` | Auto-optimizar skills con loop autonomo (patron Karpathy) |
| 20 | `skill-creator` | Crear nuevos skills para extender la fabrica |

### Agents Auto-Triggered (se activan automaticamente segun contexto)

| # | Agent | Dominio |
|---|-------|---------|
| 21 | `backend` | Server Actions, API routes, webhooks, logica servidor |
| 22 | `frontend` | React components, Tailwind, UI/UX, stores Zustand |
| 23 | `codebase-analyst` | Analisis de arquitectura, auditoria, mapeo de dependencias |
| 24 | `vercel-deployer` | Deploy a produccion, variables de entorno, dominios |
| 25 | `documentacion` | Mantener docs sincronizadas con el estado real del proyecto |
...
│
├── skills/                    # 25 skills especializados
...
│   ├── sprint/               # Tareas rapidas (1-3 archivos)
│   ├── ai/                   # AI Templates hub
...
│   ├── video-visuals/        # Paquetes visuales para videos
